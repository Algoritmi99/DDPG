...
def main():
    ...
    actor_net = Actor.ActorNet(environment.observation_space.shape[0], device, torch.double)
    ...
    target_actor_net = Actor.ActorNet(environment.observation_space.shape[0], device, torch.double)
